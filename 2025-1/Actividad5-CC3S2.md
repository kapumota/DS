...
7. Completa el nuevo issue llenando el título y la descripción para completar la historia. Asigna la etiqueta "technical debt", similar a la historia original. Elige el proyecto como "Lab Agile Planning". Una vez terminado, haz clic en el botón **"Submit new issue"**.
